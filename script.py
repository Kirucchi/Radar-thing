...
def get_start_time_pulses():
    ...
    curveX = list()
    curveY = list()
    curveX.append(interm)
    curveY.append(y)
    infiniteBool = False
    while interm < len(abscxpls) -2 and y < len(abscxpls[0]) -2:
        square = list()
        square.append(average_5_pixels(interm+1,y+1,abscxpls))
        square.append(average_5_pixels(interm-1,y+1,abscxpls))
        square.append(average_5_pixels(interm,y+1,abscxpls))
        square.append(average_5_pixels(interm+1,y,abscxpls))
        square.append(average_5_pixels(interm-1,y,abscxpls))
